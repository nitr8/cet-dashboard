...
function formatBytes($size, $precision = 2)
{
	...
	return "0 B";
    $base = log($size, 1024);
    $suffixes = array('', 'KiB', 'MiB', 'GiB', 'TiB', 'PiB', 'EiB');   
...
function getQueryProductCount ()
{
return 
 "select count(a.product)as cnt,a.product from (".
"SELECT". 
...
function getQueryLastSixWeeksNewByProduct()
{
return 
