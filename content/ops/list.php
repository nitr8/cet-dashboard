...
$retval = mysql_query( "SELECT distinct c.*,cu.displayed  FROM ".MYSQL_DB.".Customer c  left join CustomersToUser cu on c.CustomerId = cu.customerId where cu.username = '".$userName."' ", $conn );
