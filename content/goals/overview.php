...
$private = 0;
	...
	$updatesql ="Update ".MYSQL_DB.".Goals set private ='".$private."'startDate ='".date( 'Y-m-d H:i:s',strtotime($_GET['startDate']))."',description ='".$_GET['description']."',enddate='".date( 'Y-m-d H:i:s',strtotime($_GET['endDate']))."',priority='".$_GET['priority']."',recurrence='".$_GET['reccurence']."',linkedgoal='6' where idGoals=".$_GET['idGoal'];
	mysql_query( $updatesql, $conn );
}
